        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {comment.user_id === postUserId && (
              <span className="px-1 py-0.5 bg-[#2563EB] text-white text-[10px] rounded">作者</span>
            )}
          ...
          {!isReply && (
            <div className="flex items-center gap-3 mt-1">
              <button 
                ...
                className="text-xs text-gray-500 hover:text-[#2563EB]"
              >
                回复
              </button>
              {isOwner && (
      ...
      <div className="ml-6 pl-3 border-l-2 border-gray-100 mt-2">
        ...
        {hidden > 0 && (
          <button 
            ...
            className="text-xs text-[#2563EB] mt-2 flex items-center gap-1"
          >
            {isCollapsed ? (
              <>
      ...
      <div className="flex-1 overflow-y-auto pb-20">
        ...
        <div className="bg-white p-4">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <button className="px-4 py-1.5 bg-[#2563EB] text-white text-sm rounded-full">
              + 关注
            </button>
          </div>
          ...
          {user ? (
            <>
              ...
              <div className="flex-1 flex items-center gap-1 bg-gray-100 rounded-full px-2 py-1.5">
                ...
                {newComment.trim() && (
                  <button onClick={(e) => { e.stopPropagation(); handleSubmitComment(); }} className="text-[#2563EB] flex-shrink-0">
              ...
              <button
                ...
                className={`flex-shrink-0 ${showEmojiPicker ? 'text-[#2563EB]' : 'text-gray-500'}`}
                title="表情"
              >
              ...
              <button onClick={handleHeat} className="flex flex-col items-center min-w-[36px]">
                <Flame className={`w-4 h-4 ${isHeated ? 'text-[#2563EB]' : 'text-gray-500'}`} />
                <span className={`text-[9px] ${isHeated ? 'text-[#2563EB]' : 'text-gray-400'}`}>{heatCount}</span>
              </button>
              {/* 收藏 */}
              <button 
                onClick={() => {
