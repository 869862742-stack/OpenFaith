  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="p-4">
        ...
        <div className="bg-[#FEF2F2] rounded-xl border-2 border-[#E11D48] p-4 mb-4">
          <div className="flex items-center gap-3">
            <div className="relative">
              <img src={currentAccount.avatar} alt="" className="w-12 h-12 rounded-full border-2 border-[#E11D48]" />
              <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#E11D48] rounded-full flex items-center justify-center">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 bg-[#E11D48]/10 text-[#E11D48] text-[10px] rounded">CURRENT</span>
              </div>
        ...
        <button onClick={() => navigate('/login')} className="w-full h-14 border-2 border-dashed border-gray-300 rounded-xl flex items-center justify-center gap-2 text-[#64748B] hover:border-[#E11D48] hover:text-[#E11D48] transition-colors">
        ...
        <div className="mt-6 bg-[#FEF2F2] rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-sm font-bold text-[#E11D48]">账号安全提示</h3>
          </div>
